...
urlpatterns = [
    ...
    path('schedules/create/', views.ScheduleView.as_view(), name='schedule-create'),
    path('schedules/<int:pk>/update/', views.ScheduleView.as_view(), name='schedule-update'),
    path('schedules/<int:pk>/delete/', views.ScheduleView.as_view(), name='schedule-delete'),
