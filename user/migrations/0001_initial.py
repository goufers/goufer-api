    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='gofer_documents', to='main.document')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('C', 'Completed'), ('O', 'Ongoing'), ('T', 'Terminated')], default='O', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='vendor_documents', to='main.document')),
            ],
        ),
    ]
